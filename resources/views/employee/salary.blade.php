...
@section('content')
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Manage Salary</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        {!! Form::text('title','',['id'=>'expense_date','class'=>'form-control','placeholder'=>'Date','required' => 'required']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="vatid">
                                    ...
                                    <div id="netamt">
                                        <label for="after_tax_amount">Net Amount</label>
 ...
 @if (auth()->user()->user_type == 11 || auth()->user()->user_type == 2)
    <button id="newBtn" type="button" class="btn btn-info">Add New Salary</button>
    <hr>
 @endif       
                            ...
                            <div class="container">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="example">
                                        ...
                                        @empty
                                            <h3>No data found. Create a new Salary</h3>
                                        @endforelse
                                        </tbody>
                                    </table>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#addBtn").click(function(){
                if($(this).val() == 'Create') {
                    ...
                    $.ajax({
                        url: url,
                        method: "POST",
                        data: {expense_date:expense_date,account_id:account_id,account_name:account_name,ref:ref,amount:amount,tax_rate:tax_rate,tax_amount:tax_amount,after_tax_amount:after_tax_amount,transaction_type:transaction_type,payment_type:payment_type,employee_id:employee_id,description:description},
                        success: function (d) {
                            if (d.status == 303) {
                ...
                if($(this).val() == 'Update'){
                    ...
                    var employee_id= $("#employee_id").val();
                    var description= $("#description").val();
                    console.log(expense_date+',' + account_id+',' + ref+',' + amount+',' + tax_rate +','+ tax_amount+',' + after_tax_amount+',' + transaction_type+','+ payment_type+',' + description);
            ...
            $("#contentContainer").on('click','#EditBtn', function(){
                var expenseid = $(this).attr('rid');
                var info_url = url + '/'+expenseid+'/edit';
            ...
            $("#contentContainer").on('click','#deleteBtn', function(){
                ...
                var salaryid = $(this).attr('rid');
                var info_url = url + '/'+salaryid;
