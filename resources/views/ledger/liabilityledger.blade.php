                ...
                <div class="card">
                    <div class="card-header">
                        <h3> @foreach ($accountnames as $accountname)
                            ...
                            <form  action="{{route('liability_ledger_search')}}" method ="POST">
                        @csrf
                        <br>
                        <div class="container">
                            <div class="row">
                    ...
                    @forelse ($liabilities as $liabilityamt)
                            ...
                            @elseif($liabilityamt->transaction_type =='Receive'|| $liabilityamt->payment_type =='Accounts Payable' || $liabilityamt->transaction_type =='Interest')
        ...
        <table class="table table-bordered table-hover"   id="example">
            ...
            @forelse ($liabilities as $liability)
                ...
                <tr>
                    ...
                    @elseif($liability->transaction_type =='Receive'|| $liability->payment_type =='Accounts Payable' || $liability->transaction_type =='Interest')
                        <td></td>
                        <td>{{$liability->at_amount}}</td>
                        <td>{{ round($tbalance, 2) }} </td>
                        <?php $tbalance =  $tbalance - $liability->at_amount;?>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#liability_ledger").addClass('active');
        });
    </script>
@endsection
