                ...
                <div class="card">
                    <div class="card-header">
                        <h3> @foreach ($accountnames as $accountname)
                            ...
                            <form  action="{{route('currentasset_ledger_search')}}" method ="POST">
                        @csrf
                        <br>
                        <div class="container">
                            <div class="row">
                    ...
                    @forelse ($assets as $assetamt)
                           ...
                           @elseif($assetamt->transaction_type =='Payment')
                                ...
                                <table class="table table-bordered table-hover"   id="example">
                                    ...
                                    @forelse ($assets as $asset)
                                        <tr>
                                           ...
                                           @elseif($asset->transaction_type =='Payment')
                                                <td></td>{{-- debit  --}}
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#current_asset_ledger").addClass('active');
        });
    </script>
@endsection
