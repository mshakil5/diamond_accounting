            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <form  action="{{route('current_liability_ledger_search')}}" method ="POST">
                            @csrf
                            <br>
                            <div class="container">
                                <div class="row">
                    ...
                    @forelse ($liabilities as $liabilityamt)
                            ...
                            @elseif($liabilityamt->transaction_type =='Receive')
       
                                <?php $tbalance =  $liabilityamt->at_amount + $tbalance ;?>
                                    ...
                                    @forelse ($liabilities as $liability)
                                        ...
                                        <tr>
                                            ...
                                            @if($liability->transaction_type =='Payment')
                                                <td>{{$liability->at_amount}}</td>{{-- debit  --}}
                                                <td></td>{{-- credit  --}}
                                                <td>{{ round($tbalance, 2) }} </td>
                                                <?php $tbalance = $tbalance + $liability->at_amount;?>                                  

                                            @elseif($liability->transaction_type =='Receive')
                                                <td></td>{{-- debit  --}}
                                                <td>{{$liability->at_amount}}</td>{{-- credit  --}}
                                                <td>{{ round($tbalance, 2) }} </td>
                                                <?php $tbalance =  $tbalance - $liability->at_amount;?>
