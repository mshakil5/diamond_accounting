            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <form  action="{{route('employeePayable_ledger_search')}}" method ="POST">
                            @csrf
                            <br>
                            <div class="container">
                                <div class="row">
                    ...
                    @forelse ($employees as $employeeamt)
                            ...
                            @if(($employeeamt->transaction_type =='Due Adjust') && ( $employeeamt->payment_type == 'Cash' || $employeeamt->payment_type == 'Bank'|| $employeeamt->payment_type == 'Account Payable'))

                                <?php $tbalance = $tbalance - $employeeamt->at_amount;?>

                            @elseif(($employeeamt->transaction_type =='Due') && ( $employeeamt->payment_type == 'Cash' || $employeeamt->payment_type == 'Bank'|| $employeeamt->payment_type == 'Account Payable'))
                                    ...
                                    ?>
                                     @forelse ($employees as $employee)
                                        <tr>
                                            ...
                                            @if(($employee->transaction_type =='Due Adjust') && ( $employee->payment_type == 'Cash' || $employee->payment_type == 'Bank'|| $employee->payment_type == 'Account Payable'))
                                            ...
                                            @elseif(($employee->transaction_type =='Due') && ( $employee->payment_type == 'Cash' || $employee->payment_type == 'Bank'|| $employee->payment_type == 'Account Payable'))
