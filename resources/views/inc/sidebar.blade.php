        ...
        <!--<li><a class="app-menu__item" href="{{url('ownerequity')}}" id="ownerequity"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Owners Equity</span></a></li>-->
         ...
         <li class="treeview" id="allownerequity"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Owners Equity</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="{{url('ledger/shareholder-ledger')}}" id="shareholderLedger"><i class="icon fa fa-circle-o"></i>Shareholder Ledger</a></li>
...
{{-- //super admin|Read full access --}}
        ...
        <li><a class="app-menu__item" href="{{url('invoices')}}" id=""><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Invoice</span></a></li>
        <li><a class="app-menu__item" href="{{ route('admin.address') }}" id="address_active"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Address</span></a></li>
